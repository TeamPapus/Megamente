    ...
    return [
        {
            'img' : [
                ...
                '../img/deduccion/personajes/irene.svg',
        ...
        },
        {
            'img' : [
                ...
                '../img/deduccion/alimentos/fresa.svg',
                '../img/deduccion/alimentos/sandia.svg',
                '../img/deduccion/alimentos/manzana.svg',
        ...
        },
        {
            'img' : [
                ...
                '../img/deduccion/objetos/camisa-rosa.svg',
                '../img/deduccion/objetos/camisa-naranja.svg',
                '../img/deduccion/objetos/camisa-amarilla.svg',
        ...
        {
            'img' : [
                '../img/deduccion/alimentos/ciruela.svg',
                '../img/deduccion/alimentos/piña.svg',
                '../img/deduccion/alimentos/guayaba.svg',
                '../img/deduccion/alimentos/uva.svg',
         ...
         {
            'img' : [
                '../img/deduccion/objetos/chaqueta-rosa.png',
                '../img/deduccion/objetos/chaqueta-naranja.png',
                '../img/deduccion/objetos/chaqueta-verde.png',
                '../img/deduccion/objetos/chaqueta-gris.png',
                '../img/deduccion/objetos/chaqueta-azul.png'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/objetos/carro-rosa.png',
                '../img/deduccion/objetos/carro-anaranjado.png',
                '../img/deduccion/objetos/carro-azul.png',
                '../img/deduccion/objetos/carro-rosa.png',
                '../img/deduccion/objetos/carro-blanco.png'
            ],
            'pista' : [
         ...
         {
            'img' : [
                '../img/deduccion/objetos/zapato-verde.png',
                '../img/deduccion/objetos/zapato-gris.png',
                '../img/deduccion/objetos/zapato-azul.png',
                '../img/deduccion/objetos/zapato-anaranjado.png',
                '../img/deduccion/objetos/zapato-amarillo.png'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/personajes/marlon.svg',
                '../img/deduccion/personajes/rosa.svg',
                '../img/deduccion/personajes/alfredo.svg',
                '../img/deduccion/personajes/blanca.svg',
                '../img/deduccion/personajes/daniel.svg'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/objetos/globo-amarillo.png',
                '../img/deduccion/objetos/globo-blanco.png',
                '../img/deduccion/objetos/globo-rosa.png',
                '../img/deduccion/objetos/globo-rojo.png',
                '../img/deduccion/objetos/globo-azul.png'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/objetos/silla-amarilla.png',
                '../img/deduccion/objetos/silla-azul.png',
                '../img/deduccion/objetos/silla-rosa.png',
                '../img/deduccion/objetos/silla-gris.png',
                '../img/deduccion/objetos/silla-verde.png'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/objetos/calcetin-gris.png',
                '../img/deduccion/objetos/calcetin-azul.png',
                '../img/deduccion/objetos/calcetin-rosa.png',
                '../img/deduccion/objetos/calcetin-verde.png',
                '../img/deduccion/objetos/calcetin-amarillo.png'
            ],
            'pista' : [
         ...
         {
            'img' : [
                '../img/deduccion/alimentos/mango.png',
                '../img/deduccion/alimentos/cereza.png',
                '../img/deduccion/alimentos/coco.png',
                '../img/deduccion/alimentos/papaya.png',
                '../img/deduccion/alimentos/melon.png'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/personajes/frannia.svg',
                '../img/deduccion/personajes/anielka.svg',
                '../img/deduccion/personajes/juan.svg',
                '../img/deduccion/personajes/luz.svg',
                '../img/deduccion/personajes/marieth.svg'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/personajes/felix.svg',
                '../img/deduccion/personajes/reina.svg',
                '../img/deduccion/personajes/gabriel.svg',
                '../img/deduccion/personajes/antonio.svg',
                '../img/deduccion/personajes/alison.svg'
            ],
            'pista' : [
        ...
        {
            'img' : [
                '../img/deduccion/alimentos/helado-lila.png',
                '../img/deduccion/alimentos/helado-rojo.png',
                '../img/deduccion/alimentos/helado-azul.png',
                '../img/deduccion/alimentos/helado-verde.png',
                '../img/deduccion/alimentos/helado-amarillo.png'
            ],
            'pista' : [
         ...
         {
            'img' : [
                '../img/deduccion/objetos/pajaro-azul.png',
                '../img/deduccion/objetos/pajaro-verde.png',
                '../img/deduccion/objetos/pajaro-amarillo.png',
                '../img/deduccion/objetos/pajaro-rosa.png',
                '../img/deduccion/objetos/pajaro-rojo.png'
            ],
            'pista' : [
